...
const PercentBox = ({ label, value, editable = false, onChange }: { 
  label: string; 
  value: string; 
  editable?: boolean;
...
export function CreateProject({ activeAmount, onSuccess, t, kolInfo }: CreateProjectProps) {
  ...
  // 默认代币列表
  const defaultTokens = [
    { mint_base_token: 'BNB', mint_base_token_addr: '0x55d398326f99059ff775485246999027b3197955', exchange_rate: 9000000 },
    { mint_base_token: 'USDT', mint_base_token_addr: '0x55d398326f99059ff775485246999027b3197955', exchange_rate: 10000 },
    { mint_base_token: 'BTCB', mint_base_token_addr: '0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c', exchange_rate: 900000000 },
  ];
  ...
  const getTweetText = () => {
    ...
    const projectName = selectedProject.project_name?.split('100T-')[1] || selectedProject.project_name;
    return kol?.tweet 
      ? (kol.tweet as string).replace('{address}', shortAddress(address)).replace(/{name}/g, projectName)
      : `我的錢包${shortAddress(address)}已經質押SOS，正在SmartBTC.io平台提交KOL認證，參與推廣${projectName}銘文，請大家幫忙點讚、轉發這則推文，助力${projectName}銘文上SmartBTC熱門！`;
  };
  ...
  const handleSort = () => {
    ...
    const sorted = [...filteredList].sort((a, b) => {
      ...
      return newOrder === 'asc' ? marketCapA - marketCapB : marketCapB - marketCapA;
    });
  ...
  const canSelectMode = (mode: KolMode): boolean => {
    ...
    return (activeAmount >= req.min && activeAmount <= req.max) || activeAmount === 0;
  };
  ...
  const handleSubmit = async () => {
    ...
    if (activeAmount < req.min || (req.max !== Infinity && activeAmount > req.max)) {
      const tip = activeMode === 'single'
    ...
    if (activeMode === 'joint') {
      ...
      // 铭文做市商模式
      if (!typeThree.brc20_name || !typeThree.brc20_supply || !typeThree.brc20_id) {
        toast.error('請填寫完整項目信息');
        return;
      }
      ...
      {activeTab === 'create' ? (
        <>
            ...
            <div className="text-left">
              ...
              <div className="flex items-center justify-between gap-3">
                <div className="w-1/2">
                  ...
                  <input
                    ...
                    onChange={(e) => setTypeOne({ ...typeOne, brc20_name: e.target.value })}
                ...
                <div className="w-1/2">
                  ...
                  <input
                    ...
                    onChange={(e) => setTypeOne({ ...typeOne, symbol: e.target.value })}
                    placeholder={createProject.custom as string}
                    className="input text-sm"
                  />
                </div>
              ...
              <div className="mt-5">
                ...
                <div className="space-y-2">
                  ...
                  <PercentBox label={createProject.launchPoolContract as string} value={typeOne.percents[2]} />
                  <PercentBox label={createProject.kolUnlockContract as string} value={typeOne.percents[3]} />
                </div>
              </div>
              ...
              <div className="mt-5">
                ...
                <input
                  ...
                  onChange={(e) => setTypeOne({ ...typeOne, details: e.target.value })}
            ...
            <div className="text-left">
              ...
              <div className="flex items-center justify-between gap-3">
                <div className="w-1/2">
                  ...
                  <input
                    ...
                    onChange={(e) => setTypeTwo({ ...typeTwo, brc20_name: e.target.value })}
                    placeholder={createProject.custom as string}
                    className="input text-sm"
                  />
                </div>
                <div className="w-1/2">
                  ...
                  <input
                    ...
                    onChange={(e) => setTypeTwo({ ...typeTwo, symbol: e.target.value })}
                    placeholder={createProject.custom as string}
                    className="input text-sm"
                  />
                </div>
              ...
              <div className="mt-5">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <PercentBox label={createProject.launchPoolContract as string} value={typeTwo.percents[2]} />
                  <PercentBox 
              ...
              <div className="mt-5">
                ...
                <input
                  ...
                  onChange={(e) => setTypeTwo({ ...typeTwo, details: e.target.value })}
                  placeholder={createProject.descriptionPlaceholder as string}
                  className="input text-sm"
                />
              </div>
            ...
            <div className="text-left">
              ...
              <div className="flex items-center justify-between gap-3">
                <div className="w-1/2">
                  ...
                  <input
                    ...
                    onChange={(e) => setTypeThree({ ...typeThree, brc20_name: e.target.value })}
                ...
                <div className="w-1/2">
                  ...
                  <input
                    ...
                    onChange={(e) => setTypeThree({ ...typeThree, brc20_supply: e.target.value })}
                    placeholder={newData.equalAmountToInscription || '與銘文等量'}
                    className="input text-sm"
                  />
                </div>
              </div>
              ...
              <div className="mt-5">
                ...
                <input
                  ...
                  onChange={(e) => setTypeThree({ ...typeThree, brc20_id: e.target.value })}
                  className="input text-sm"
                />
              </div>
              ...
              <div className="mt-5">
                ...
                <div className="space-y-2">
                  <PercentBox 
                    ...
                    editable 
                    onChange={(v) => setTypeThree({ ...typeThree, percents: [v, typeThree.percents[1], typeThree.percents[2], typeThree.percents[3]] })}
                  />
                  <PercentBox 
                    label={newData.lpAddition || 'LP添加'} 
                    value={typeThree.percents[1]} 
                    editable 
                    onChange={(v) => setTypeThree({ ...typeThree, percents: [typeThree.percents[0], v, typeThree.percents[2], typeThree.percents[3]] })}
                  />
                  <PercentBox 
                    label={newData.launchPool || '啟動池'} 
                    value={typeThree.percents[2]} 
                    editable 
                    onChange={(v) => setTypeThree({ ...typeThree, percents: [typeThree.percents[0], typeThree.percents[1], v, typeThree.percents[3]] })}
                  />
                  <PercentBox 
                    label={newData.kolRewards || 'KOL獎勵'} 
                    value={typeThree.percents[3]} 
                    editable 
                    onChange={(v) => setTypeThree({ ...typeThree, percents: [typeThree.percents[0], typeThree.percents[1], typeThree.percents[2], v] })}
                  />
                </div>
              </div>
              ...
              <div className="mt-5">
                ...
                <input
                  ...
                  onChange={(e) => setTypeThree({ ...typeThree, details: e.target.value })}
          ...
          <div className="w-full text-center my-6">
            ...
            >
              {loading ? (common?.loading as string || '加載中...') : (home?.createProject as string || '創建項目')}
            </button>
          </div>
          ...
          {filteredList.length > 0 ? (
            <div className="max-h-[500px] overflow-y-auto space-y-3">
              {filteredList.map((project, index) => {
                const marketCap = project.total_supply && project.lastPrice 
                  ? (Number(project.total_supply) * Number(project.lastPrice)).toFixed(0)
                  : '0';
                const projectTypes = shareProject?.projectTypes as Record<string, string> || {};
                const projectTypeName = project.project_type === 2
