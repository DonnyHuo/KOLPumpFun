const lan = {
  ...
  home: {
    ...
    progressDesc:
      "備註：每發生一筆新的跨鍊或LP兌換，均將根據當筆數量對應比例觸發一次新的KOL奖励",
    dispositNumber: "質押數量",
    liftDisposit: "解除質押",
  ...
  kol: {
    ...
    binanceSquare: "關注官推",
    desc1:
      'KOL認證時，請關注官推@SmartBTCdao，轉發其置頂推文，同步配文認證信息"影響力資產智能發幣平台kolpump.fun認證碼+錢包地址後4位"',
    submit: "提交認證",
    kolReview: "待審核中...",
    certified: "已認證",
    inputPlaceholder: {
  ...
  newData: {
    ...
    kolRewards: "KOL獎勵",
    kolRewardsContract: "KOL奖励合约",
    kolRewardsContractTooltip:
      "*KOL奖励合约数值≤您实际质押的SOS数量÷1000，且为整数，例如实际质押了20500个SOS，则KOL比例可填写20以内的整数；选择单一KOL模式应至少质押10000个SOS。",
    lpAddition: "LP添加",
    launchPool: "啟動池",
    launchPoolNote:
