const lan = {
  ...
  home: {
    ...
    progressDesc:
      "備註：每發生一筆新的跨鏈或LP兌換，均將根據當筆數量對應比例觸發一次新的KOL獎勵",
    dispositNumber: "質押數量",
    liftDisposit: "解除質押",
  ...
  create: {
    title: "KOL自定義一鍵發幣平台",
    subtitle: "你的影響力有多大，你佔項目代幣的份額就有多大",
  ...
  deposit: {
    stakeNote:
      "SOS質押數量越多，KOL分配代幣越多，解鎖越快；每100SOS約可分配0.1%項目代幣總量",
  ...
  newData: {
    ...
    kolRewards: "KOL獎勵",
    kolRewardsContract: "KOL獎勵合約",
    kolRewardsContractTooltip:
      "*KOL獎勵合約數值≤您實際質押的SOS數量÷1000，且為整數，例如實際質押了20500個SOS，則KOL比例可填寫20以內的整數；選擇單一KOL模式應至少質押10000個SOS。",
    lpAddition: "LP添加",
    launchPool: "啟動池",
    launchPoolNote:
